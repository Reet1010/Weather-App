...
function updateDOM(data) {
    ...
    if (imgdiv.innerHTML != "") {imgdiv.innerHTML = "";} // removes the previous image first if some image was already present in the imgdiv so that more than 1 images never get attached in the div.
    imgdiv.append(image);
...
`
        ...
        alert("Unable fetching data. Please try after some time or with a different city name.");
    }
}